...
CAST = {
 "N-NARR": dict(sex="MAN", side="left", wall="warm white", floor="worn honey-coloured floorboards",
   face="A long oval face with warm hazel eyes that crinkle deeply at the corners, a strong straight nose, full cheeks and a wide easy mouth — an open, friendly face, the kind that says hello first. A deep cleft in the chin — his one marker. The right eye sits a touch lower than the left",
   hair="A full head of wavy dark-grey hair worn a little long over the collar, and a neat short beard of salt-and-pepper, the same tone and the same length in every panel",
   body="A white British man. Medium height, solid and a little soft around the middle, relaxed shoulders, sixty years old",
   ward="A navy crew-neck knitted jumper with the collar of a blue checked shirt showing, dark blue jeans and brown suede desert boots",
 ...
 "C3-PAT": dict(sex="WOMAN", side="right", wall="pale duck-egg", floor="light oak floorboards",
   face="A wide heart-shaped face with round apple cheeks, bright brown eyes that crease easily, a small snub nose and a generous mouth — a warm, lively grandmother's face. A heavy dusting of freckles across the nose and cheeks — her one marker. The left cheek lifts slightly higher than the right",
   hair="Shoulder-length sandy hair gone mostly grey, pulled back in a loose low ponytail with a few strands falling at the temples, the same tone and the same ponytail height in every panel",
   body="A white British woman. Sturdy and compact, strong shoulders, a straight upright stance, sixty-six years old",
   ward="A navy quilted gilet over a blue-and-white striped long-sleeve top, stone-coloured cotton shorts ending just above the knee so both knees are bare, and white canvas trainers",
   age="fine laugh lines from the corners of both eyes, soft lines around the mouth, light crepe under the eyes, freckling that runs down onto the neck"),
