# intake-1 — B-roll plan (step 5 draft, Manual — nothing generated)

Build: STRYDE · Identity Callout · voice-only narrated ad (every frame B-roll, §30H rule 4) · Mode 1.
**Knee: right** — script names no knee -- default right (matches the locked worn references) (`side_from_script`, SIDE_RULE).

Durations are **estimates** (words ÷ 2.6 + 0.5s, min 3s). Per E6 they become `pending-master` and are replaced by the voice master's word timestamps before any call.
**Anatomy looks (user, V7.49.31):** ANAT-A full stack on the point and protection beats (BR-02, 03, 10, 11, 21), with `ANAT_A_POINT_TIGHT`; ANAT-B ghost limb on the condition beats (BR-14, 16, 17).

References come from `refs_for()` in the product sheet; MECH beats use the anatomical register (§12A) with no product photo; the copy never gets a STRYDE reference.
...
| BR-02 | 1 | puts seventeen times your bodyweight | MECH | **ANAT-A** (+ tight-spot clause) — Anatomical mechanism: the load arriving at the knee at walking cadence | — | 5 | 3 | 17× confirmed; the number is a post overlay, never generated |
| BR-03 | 1 | through one small spot below your kneecap | MECH | **ANAT-A** (+ tight-spot clause) — Anatomical close: one small hot spot glowing on the patellar tendon just below the kneecap | — | 7 | 4 |  |
...
| BR-10 | 3 | catches the force and moves it off the worn part, | MECH | **ANAT-A** (+ tight-spot clause) — Mechanism: the load arriving, the shell catching it and spreading it away from the worn spot | — | 10 | 5 | protection claim |
| BR-11 | 3 | before it hits the joint. | MECH | **ANAT-A** (+ tight-spot clause) — Mechanism: the joint below stays calm, the load never reaching it | — | 5 | 3 |  |
...
| BR-14 | 5 | Built for bone on bone, | MECH | **ANAT-B** — Anatomical: bone meeting bone in the knee | — | 5 | 3 |  |
| BR-15 | 5 | arthritis, | BR | An older hand rubbing a sore knee on the sofa (before-state, no strap) | — | 1 | 3 |  |
| BR-16 | 5 | worn cartilage | MECH | **ANAT-B** — Anatomical: thinned, worn cartilage | — | 2 | 3 |  |
| BR-17 | 5 | and meniscus. | MECH | **ANAT-B** — Anatomical: the meniscus | — | 2 | 3 |  |
| BR-18 | 6 | So you walk further, | PRODUCT | Worn, walking a path outdoors, easy stride (after-state §30D) | front.webp + back.webp + worn_front.jpg | 4 | 3 |  |
| BR-19 | 6 | and take the stairs without gripping the rail. | PRODUCT | Worn, climbing stairs with a reciprocal gait, hand clear of the rail (§30D) | front.webp + back.webp + worn_bent.jpg | 8 | 4 |  |
| BR-20 | 6 | Not because the arthritis has gone. | PRODUCT | Tone turn — calm and honest: seated, knee bent, strap on, hands resting in the lap | front.webp + back.webp + worn_bent.jpg | 6 | 3 | after-states never touch the knee |
| BR-21 | 6 | Because the force isn't landing where it hurts. | MECH | **ANAT-A** (+ tight-spot clause) — Mechanism: the load landing on the shell, the sore spot staying calm | — | 8 | 4 |  |
| BR-22 | 7 | Adjustable. | PRODUCT | SEAT_LOCK — the closed strap slid up from mid-shin and seated on the tendon; never adjusted | front.webp + back.webp + worn_front.jpg | 1 | 3 | ADJUSTABLE_RULE — the word never enters the prompt |
| BR-23 | 7 | No slipping. | PRODUCT | Worn in motion on the stairs, the strap holding station through the step | front.webp + back.webp + worn_front.jpg | 2 | 3 |  |
| BR-24 | 7 | No sores. | PRODUCT | Rear close: the soft knit band on healthy skin behind the knee | front.webp + back.webp + worn_rear.jpg | 2 | 3 |  |
...
2. Cast — the hero wearer (§19, British, 55–80), the orthopaedic surgeon (§19B), the sports scientist, the one-off wearer for BR-29, the patient for BR-28.
3. Locations + plates (§30C) — home (stairs, living room, kitchen, hall), clinic, sports lab, outdoor path.
4. Wardrobe map (§21) — shorts on the revealed/worn beats, trousers on BR-26/27 (§9D).
5. Voice master (§22U) — its word timestamps set every B-roll duration (E6).
