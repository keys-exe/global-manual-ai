...
SC["SC05"] = dict(title="Scene 4 · Kitchen, a week later", day="D3", loc="L-KIT", house=True,
 ...
 frames=[
  ...
  dict(id="SC05-F02-B-MCU", scale="MCU", rig="F2", who=["BARBARA"], off="Margaret across the table, camera-right",
  ...
  dict(id="SC05-F03-M-CU", scale="CU", rig="F2", who=["MARGARET"], off="Barbara across the table, camera-left",
  ...
  dict(id="SC05-F05-B-MCU-CANDID", scale="MCU", rig="F1", who=["BARBARA"], off="Margaret across the table, camera-right", product="worn-B",
  ...
  dict(id="SC05-F06-M-CU-SCEPTIC", scale="CU", rig="F2", who=["MARGARET"], off="Barbara across the table, camera-left",
  ...
  dict(id="SC05-F08-B-CU-TRUTH", scale="CU", rig="F1", who=["BARBARA"], off="Margaret across the table, camera-right",
  ...
  dict(id="SC05-F09-M-CU-RAW", scale="CU", rig="F1", who=["MARGARET"], off="Barbara across the table, camera-left",
