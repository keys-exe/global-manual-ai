...
C20 = {
 "MARGARET": [("Accent","Nottinghamshire, placed (British confirmed by you; region as proposed). Excludes RP, southern and American vowels"),
 ...
 "BARBARA": [("Accent","Black Country, placed (British confirmed by you; region as proposed). Excludes Birmingham caricature and RP"),
 ...
 "FRANK": [("Accent","Nottinghamshire, broader than Margaret's (British confirmed; region as proposed)"),("Pacing","Fast run-on strings (measured 235 wpm); slowed to ~180 in SC03 and on 'I told him not to come'"),
 ...
 "EMILY": [("Accent","Nottingham, young (British confirmed; region as proposed)"),("Pacing","Quick, bouncing"),("Posture","Open, hands outstretched to Margaret"),("Rest position","Hands held out, then at her sides"),
 ...
 "DOCTOR": [("Accent","Educated Edinburgh (British confirmed; region as proposed)"),("Pacing","Brisk, even, ~210 wpm"),("Posture","Seated at the desk, turns to the monitor, leans in once"),("Rest position","One hand on the mouse, one on the desk"),
