...
- **The Board tab's Absorption widget** *(user's named change, 2026-09-26)*: absorption makes a document, not renders, so the widget shows the Absorption Sheet's key measured readings and opens it in the Plan tab; before step 1 is written it says where the sheet will appear. It never sits empty.
