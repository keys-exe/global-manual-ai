...
**Automatic run mode only** *(correction 2026-09-26, user)*. In Manual every clip goes on the Generation Board as To check and the user confirms it or sends it to Fix (§16A); the agent does not judge it.
